...
- **BEng Electronic Engineering**, University of Manchester (Sept 2023 – July 2026). First-Class track. Key modules: Digital Systems Design (VHDL), Embedded Systems (C), Computer Architecture, DSP, Control Systems, High-Speed Digital & Mixed-Signal. Main projects: line-following buggy (PID on MCU); report on Shor's algorithm.
- **A-Levels**, Kolej Yayasan UEM (KYUEM), Malaysia — 1A* & 3A's (Further Maths A*, Maths, Physics, Chemistry).
- **Cambridge IGCSE**, Wesley Methodist School Penang International — 7 A* & 2 A's.
...
- **Volunteer Tutor, Selfless Together** (Jul–Oct 2021). Taught Mathematics and English to refugees; planned classes and materials.
- **Volunteer, Pandemic Food Bank** (Jul–Aug 2021, CLOB86). Distributed food to 4,500 recipients; raised $30,000 in donations.
